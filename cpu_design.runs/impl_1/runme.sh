...
HD_PWD='E:/desktop/cpu_design/cpu_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_2_top.tcl -notrace
