...
HD_PWD='E:/desktop/cpu_design/cpu_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_2_top.tcl
